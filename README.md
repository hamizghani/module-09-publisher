...
![RabbitMQ management overview](images/rabbitmq-overview.jpeg)
...
The screenshot above shows that the RabbitMQ management dashboard is running and ready to receive AMQP connections from the Rust programs.
...
The RabbitMQ overview screenshot is included above as the available dashboard evidence for this experiment.
